  ...
  <form id="main-form" class="smart-form">
    ...
    <label class="checkbox">
      <i class="fa fa-lg fa-tag"></i> Marcar Todos
          <input @click="checkallmodules" :checked="allSelected()" type="checkbox" name="checkbox-inline">
          <i></i>
    </label>
    </fieldset>
              ...
              <tr>
                <th colspan="2" class="text-center">
                  ...
                  <i class="fa fa-lg fa-tag"></i> {{ details.name.toUpperCase() }}
                      <input @click="checkall(module)" :checked="allModuleSelected(module)" type="checkbox" name="checkbox-inline">
                      <i></i>
                  </label>
              </th>
              </tr>
            ...
            <tbody>
              <template v-for="(action, actionKey) in details.actions">
                <tr>
                  ...
                  <td>
                    <label class="checkbox">
                      <input v-model="selectedPermissions" :value="module + '|' + actionKey" type="checkbox" name="checkbox-inline">
