    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <h1 class="page-title txt-color-blueDark">
        ...
        <div class="pull-right">
          <router-link :to="{path: '/tenants'}" class="btn btn-default">
      ...
      <div class="jarviswidget">
        ...
        <div role="content">
          <div class="widget-body no-padding">
            <tenant-form ref="tenantForm" :readonly="readonly"></tenant-form>
          </div>
        </div>
      </div>
    </div>
...
<script>
  import TenantForm from '@/components/Resources/Tenants/Create/CreateForm'
